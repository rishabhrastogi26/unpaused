    ...
    if n%2==0:
        ...
        try:
            ...
            try:
                ...
                #global video
                #global video_stream
                #videos = [f for f in listdir(r'C:\Users\siddh\.spyder-py3\unpaused\final\videos')]
                #if n==0:
                #    video=cv2.VideoCapture(r'C:\Users\siddh\.spyder-py3\unpaused\final\videos'+str(random.choice(videos)))
                #if n!=0:
